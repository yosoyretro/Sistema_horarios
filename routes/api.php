...
Route::prefix('istg')->group(
    function () {
        ...
        //USUARIO
        Route::post("usuarios", [UsuarioController::class, 'storeUsuarios']); // Crear usuario
        // Route::post("edit_usuario/", [UsuarioController::class, 'editUser']);
        Route::get("usuarios", [UsuarioController::class, 'showUsuarios']); // Mostrar todos los usuarios
        Route::delete("usuarios/{id}", [UsuarioController::class, 'deleteUsuario']); // Eliminar usuario por ID
        ...
        // Rutas para Títulos Académicos
        Route::get("titulos-academicos", [TituloAcademicoController::class, 'showTituloAcademico']); // Mostrar todos los títulos académicos
        Route::post("titulos-academicos", [TituloAcademicoController::class, 'storeTituloAcademico']); // Crear título académico
        Route::put("titulos-academicos/{id}", [TituloAcademicoController::class, 'updateTituloAcademico']); // Actualizar título académico por ID
        Route::delete("titulos-academicos/{id}", [TituloAcademicoController::class, 'deleteTituloAcademico']); // Eliminar título académico por ID
