!(function (e, t) {
    ...
    var Te =
            "Enero_Febrero_Marzo_Abril_Mayo_Junio_Julio_Agosto_Septiembre_Octubre_Noviembre_Diceimbre".split(
                "_"
            ),
    ...
    var ft =
        ...
        wt = /^\/?Date\((-?\d+)/i,
        pt =
            /^(?:(Lun|Mar|Mie|Jue|Vie|Sab|Dom),?\s)?(\d{1,2})\s(Ene|Feb|Mar|Abr|May|Jun|Jul|Ago|Sep|Oct|Nov|Dic)\s(\d{2,4})\s(\d\d):(\d\d)(?::(\d\d))?\s(?:(UT|GMT|[ECMP][SD]T)|([Zz])|([+-]\d{4}))$/,
        vt = {
            UT: 0,
            GMT: 0,
            EDT: -240,
