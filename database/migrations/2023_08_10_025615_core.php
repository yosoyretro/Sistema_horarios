...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('instituto',function(Blueprint $table){
            ...
            $table->date('created_at'); // Columna de fecha de creación
            $table->timestamp('updated_at')->nullable(); // Columna de marca de tiempo de actualización
        ...
        Schema::create('carrera',function(Blueprint $table){
            ...
            $table->string('estado',2)->default('A');
            $table->date('created_at'); // Columna de fecha de creación
            $table->timestamp('updated_at')->nullable(); // Columna de marca de tiempo de actualizació
        });
