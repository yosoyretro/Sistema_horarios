                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>Aula 102</td>
                                <td>
                                    <button class="btn btn-warning btn-sm" data-toggle="modal" data-target="#editarModal">Editar</button>
                ...
                <form>
                    <div class="form-row">
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" id="asignatura" placeholder="Nombre de la asignatura">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="horario">Horario</label>
                            <input type="text" class="form-control" id="horario" placeholder="Horario de la asignatura">
                        </div>
                        <div class="form-group col-md-4">
                            <label for="aula">Aula</label>
                            <input type="text" class="form-control" id="aula" placeholder="Aula de la asignatura">
                        </div>
                    </div>
