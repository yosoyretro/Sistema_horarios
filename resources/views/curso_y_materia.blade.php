...
@section('titulo', 'cursos y materias')
@section('content')
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <br>
    <h2><img height="75px" src="{{ asset('icons/cursosym.png') }}">cursos y materia</h2>
        ...
        <div class="container-fluid">
            <div class="row pt-4">
                <div class="col-3 input-group mb-3 ml-3">
                    ...
                    <input type="search" class="form-control" placeholder="Buscar Cursos">
                </div>
            </div>
    ...
    <div class="card p-2 card-bg">
        <div class="container-fluid">
            <div class="row pt-4">
                <div class="col-3 input-group mb-3 ml-3">
                    <span class="input-group-text fondo-istg text-white" id="basic-addon1"><i class="bi bi-search text-negita"></i></span>
                    <input type="search" class="form-control" placeholder="Buscar materias">
                </div>
            </div>
