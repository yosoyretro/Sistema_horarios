        ...
        <div class="card-body">
            <table class="table texto-dark text-center table-bordered table-white justify-content-end">
                ...
                <tbody class="bg-light text-black font-lg">
                    ...
                    @if($usuarios_datos)
                        @foreach($usuarios_datos as $data)
                            <tr>
                                <th>{{$data->cedula}}</th>
                                <th>{{$data->nombres}}</th>
                                <th>{{$data->usuario}}</th>
                                ...
                                <th>
                                    <button class="btn btn-warning text-white"><strong><i class="fas fa-pencil-alt"></i>Editar</strong></button>
                                    <button class="btn btn-danger" onclick="mensaje_eliminar()"><strong><i class="fas fa-trash"></i> Eliminar</strong></button>
                                </th>
                            </tr>
                        @endforeach
                    @else
            ...
            <div class="modal-dialog">
                <div class="modal-content bg-light">
                    ...
                    <div class="modal-footer">
                        <button name="adjuntar" type="submit" class="btn w-100 border-white text-white" style="background:#3f4bb9;">Crear Usuario</button>
                    </div>
                </div>
            </div>
        </div>
