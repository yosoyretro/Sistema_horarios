                    ...
                    <div class="col">
                        ...
                        <div id="titulosAcademicosContainer"
                            ...
                            <div class="btn-group custom-checkbox col-auto"
                                ...
                                <input type="checkbox" class="btn-check" id="checkbox{{ $titulo->id_titulo_academico }}"
                                    autocomplete="off">
                ...
                <div class="row mb-2">
                    <div class="col">
                        ...
                        <div class="input-group has-validation">
                            <input id="input_usuario" type="text" placeholder="Ingrese el usuario" class="form-control"
                                minlength="5" maxlength="25" pattern=".{6,}" title="Debe tener al menos 6 caracteres">
